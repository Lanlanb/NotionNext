...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'fdac813f9c548291a41801f15079bcfe',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Bulan. N', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Pembelajar amatir yang taat', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nurlaelabulan.my.id', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Portfolio, Web, Blog, Data Scientist, Analisis Data', // 网站关键词 英文逗号隔开
